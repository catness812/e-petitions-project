...
type SecurityServiceClient interface {
	...
	ValidateOTP(ctx context.Context, in *OTPInfo, opts ...grpc.CallOption) (*OTPInfo, error)
}
...
func (c *securityServiceClient) ValidateOTP(ctx context.Context, in *OTPInfo, opts ...grpc.CallOption) (*OTPInfo, error) {
	out := new(OTPInfo)
...
type SecurityServiceServer interface {
	...
	ValidateOTP(context.Context, *OTPInfo) (*OTPInfo, error)
...
func (UnimplementedSecurityServiceServer) ValidateOTP(context.Context, *OTPInfo) (*OTPInfo, error) {
