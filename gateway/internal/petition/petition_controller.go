...
func (c *petitionController) CreatePetition(ctx *fiber.Ctx) error {
	...
	if err != nil {
		return ctx.Status(fiber.StatusBadRequest).JSON(fiber.Map{"error": err.Error(), "petition_id": resp})

	}

	return ctx.Status(fiber.StatusCreated).JSON(fiber.Map{"petition_id": resp})
}
...
func (c *petitionController) GetPetitionByID(ctx *fiber.Ctx) error {
	...
	if err != nil {
		...
		return ctx.Status(fiber.StatusBadRequest).JSON(fiber.Map{"message": "Failed to get the id", "error": err})
	...
	if err != nil {
		return ctx.Status(fiber.StatusInternalServerError).JSON(fiber.Map{"error": "Failed to retrieve petition"})
...
func (c *petitionController) CreateVote(ctx *fiber.Ctx) error {
	...
	if err != nil {
		...
		return ctx.Status(fiber.StatusBadRequest).JSON(fiber.Map{"message": "Invalid 'uid' parameter", "error": err.Error()})
	...
	if err != nil {
		...
		return ctx.Status(fiber.StatusBadRequest).JSON(fiber.Map{"message": "Invalid 'pid' parameter", "error": err.Error()})
...
func (c *petitionController) GetUserPetitions(ctx *fiber.Ctx) error {
	...
	if err != nil {
		...
		return ctx.Status(fiber.StatusBadRequest).JSON(fiber.Map{"message": "Invalid 'page' parameter", "error": err.Error()})
	}
	...
	return ctx.Status(fiber.StatusOK).JSON(fiber.Map{"user_petitions": res})
}
...
func (c *petitionController) GetUserVotedPetitions(ctx *fiber.Ctx) error {
	...
	return ctx.Status(fiber.StatusOK).JSON(fiber.Map{"user_voted_petitions": res})
}
...
func (c *petitionController) GetAllSimilarPetitions(ctx *fiber.Ctx) error {
	...
	return ctx.Status(fiber.StatusOK).JSON(fiber.Map{"petitions": res})
}
...
func (c *petitionController) SearchPetitionsByTitle(ctx *fiber.Ctx) error {
	...
	return ctx.JSON(fiber.Map{"petitions": res})
}
