...
type PetitionServiceClient interface {
	...
	UpdatePetition(ctx context.Context, in *UpdatePetitionRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *petitionServiceClient) UpdatePetitionStatus(ctx context.Context, in *UpdatePetitionStatusRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *petitionServiceClient) UpdatePetition(ctx context.Context, in *UpdatePetitionRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *petitionServiceClient) DeletePetition(ctx context.Context, in *PetitionId, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *petitionServiceClient) CreateVote(ctx context.Context, in *CreateVoteRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type PetitionServiceServer interface {
	...
	UpdatePetition(context.Context, *UpdatePetitionRequest) (*empty.Empty, error)
...
func (UnimplementedPetitionServiceServer) UpdatePetition(context.Context, *UpdatePetitionRequest) (*empty.Empty, error) {
