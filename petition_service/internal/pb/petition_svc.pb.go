...
var file_petition_svc_proto_rawDesc = []byte{
	...
	0x2f, 0x65, 0x6d, 0x70, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xa6, 0x03, 0x0a,
...
var file_petition_svc_proto_depIdxs = []int32{
	...
	4, // 6: proto.PetitionService.GetPetitionById:output_type -> proto.Petition
	0, // 7: proto.PetitionService.CreatePetition:output_type -> proto.PetitionId
	5, // 8: proto.PetitionService.GetPetitions:output_type -> proto.GetPetitionsResponse
	6, // 9: proto.PetitionService.UpdatePetitionStatus:output_type -> google.protobuf.Empty
	6, // 10: proto.PetitionService.DeletePetition:output_type -> google.protobuf.Empty
	6, // 11: proto.PetitionService.ValidatePetitionId:output_type -> google.protobuf.Empty
